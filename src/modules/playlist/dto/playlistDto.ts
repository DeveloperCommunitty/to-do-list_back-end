...
export class CreatePlaylistDto{
    ...
    @ApiProperty({ example: '72704273-d483-423a-1234-9b5b8447568a', description: 'Id do Usuario'})
    @IsNotEmpty()
    userId:string;
...
export class UpdatePlaylistDto{
    ...
    @ApiProperty({ example: 'Uma playlist para verificar minhas receitas V2', description: 'Descrição da Playlist'})
    @IsNotEmpty()
    description:string;
}